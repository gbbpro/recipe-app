    ...
    if (favoritesOnly) {
      fetch("/api/favorites")
        ...
        .then((data) => {
          ...
          if (search)
            filtered = filtered.filter((r: { name: string }) =>
              r.name.toLowerCase().includes(search.toLowerCase()),
            );
          if (activeTag)
            filtered = filtered.filter((r: { tags: string[] }) =>
  ...
  return (
    <main>
          ...
          >
            ...
            >
              {favoritesOnly
                ? "⭐ Favorites"
                : activeTag
                  ? `${activeTag.charAt(0).toUpperCase() + activeTag.slice(1)} Recipes`
                  : "All Recipes"}
            </h1>
            <form
            ...
            >
              ...
              >
                <input
                  ...
                  style={{
                    padding: "8px 32px 8px 14px", // ← add right padding for the X
      ...
      >
        {/* Sidebar filters */}
        <aside
          className="browse-sidebar no-print"
            ...
            {ALL_TAGS.map((tag) => (
              <button
                ...
                style={{
                  ...
                  background:
                    activeTag === tag ? "var(--accent-light)" : "transparent",
...
export default function RecipesPage() {
  return (
    <Suspense
      fallback={
        <div style={{ padding: "64px 24px", color: "var(--text-muted)" }}>
          Loading...
        </div>
      }
    >
