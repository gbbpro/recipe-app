...
const UNIT_CONVERSIONS = [
  {
    from: ["tsp", "teaspoon", "teaspoons"],
    toUnit: "tbsp",
    factor: 3,
    threshold: 3,
  },
  {
    from: ["tbsp", "tablespoon", "tablespoons"],
    toUnit: "cup",
    factor: 16,
    threshold: 4,
  },
  {
    from: ["fl oz", "fluid ounce", "fluid ounces"],
    toUnit: "cup",
    factor: 8,
    threshold: 8,
  },
  {
    from: ["ml", "milliliter", "milliliters"],
    toUnit: "l",
    factor: 1000,
    threshold: 1000,
  },
        ...
        >
          ...
          <div>
                ...
                {SCALE_OPTIONS.map((opt) => (
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      background:
                        scale === opt.value ? "var(--accent)" : "transparent",
                      color:
                        scale === opt.value ? "white" : "var(--text-muted)",
                      fontSize: "0.7rem",
                      fontWeight: 600,
                      cursor: "pointer",
                      transition: "all 0.15s",
            ...
            {sections.map((section, i) => (
              <div
                key={i}
                style={{ marginBottom: section.label ? "20px" : "0" }}
              >
                {section.label && (
                  <div
                    style={{
